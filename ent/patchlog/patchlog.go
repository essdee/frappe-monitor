...
const (
	// Label holds the string label denoting the patchlog type in the database.
	Label = "patch_log"
	...
	// Table holds the table name of the patchlog in the database.
	Table = "patch_logs"
)

// Columns holds all SQL columns for patchlog fields.
var Columns = []string{
	FieldID,
	FieldName,
	FieldAppliedAt,
...
// OrderOption defines the ordering options for the PatchLog queries.
